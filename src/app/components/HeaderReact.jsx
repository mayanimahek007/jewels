...
export default function HeaderReact() {
  ...
  return (
    <header className="w-full">
      {/* Top Bar */}
      <div className="bg-[#2B4E4E] text-white text-sm py-2 px-4 flex items-center justify-between">
        {/* Left: Social Icons */}
        ...
        <div className="mx-auto px-16 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center relative group">
            <input
              ...
              className="pl-0 pr-10 py-2 w-64 border-b-2 border-gray-300 bg-transparent focus:border-[#0a1f44] focus:outline-none transition-all duration-300"
            />
          ...
          <div className="flex items-center gap-5 flex-1 justify-end">
            <UserRound strokeWidth={1.2} size={28} />
          ...
          {/* Category Nav */}
          <div className="flex items-center justify-center gap-6 text-sm font-medium py-2 bg-[#2B4E4E]">
            <Link href="/rings">Rings</Link>
            <Link href="/bracelets" className="border-b-2 border-black">Bracelets</Link>
            <Link href="/earrings">Earrings</Link>
            <Link href="/pendants">Pendants</Link>
            <Link href="/gold">Gold</Link>
            <Link href="/silver">Silver</Link>
            <Link href="/custom-jewellery">Custom Jewellery</Link>
          </div>
      </div>
        ...
        <div className="px-4 pt-3">
          <div className="relative">
            <input
              type="text"
              placeholder="Search Product Here"
              className="w-full rounded-md bg-[#f5f5f5] pl-4 pr-10 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0a1f44] border-none"
            />
